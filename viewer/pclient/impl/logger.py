...
class Message:
    ...
    def __init__(self, text: str, log_level: LogLevel) -> None:
        self._text = text
...
class Logger:  # TODO: PyDoc
    ...
    def print(self, *message: Any, channel: int = 0, sep: str = " ", end: str = "\n") -> None:
        self.messages.append(Message(sep.join(message), LogLevel.INFO))
    ...
    def debug(self, *message: Any, sep: str = " ", end: str = "\n") -> None:
        ...
        self.messages.append(Message(sep.join(message), LogLevel.DEBUG))
        message = list(message)
    ...
    def warn(self, *message: Any, sep: str = " ", end: str = "\n") -> None:
        ...
        self.messages.append(Message(sep.join(message), LogLevel.WARN))
        message = list(message)
    ...
    def error(self, *message: Any, sep: str = " ", end: str = "\n") -> None:
        ...
        self.messages.append(Message(sep.join(message), LogLevel.ERROR))
        message = list(message)
    ...
    def fatal(self, *message: Any, sep: str = " ", end: str = "\n") -> None:
        ...
        self.messages.append(Message(sep.join(message), LogLevel.FATAL))
        message = list(message)
